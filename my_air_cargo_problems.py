...
def air_cargo_p2() -> AirCargoProblem:
    ...
    neg = [expr('At(C1, JFK)'), expr('At(C1, ATL)'),  expr('At(P1, JFK)'),  expr('At(P1, ATL)'), expr('In(C1, P1)'),  expr('In(C1, P2)'), expr('In(C1, P3)'),
            expr('At(C2, SFO)'), expr('At(C2, ATL)'), expr('At(P2, SFO)'),  expr('At(P2, ATL)'), expr('In(C2, P1)'),  expr('In(C2, P2)'), expr('In(C2, P3)'),
            expr('At(C3, SFO)'), expr('At(C3, JFK)'), expr('At(P3, SFO)'),  expr('At(P3, JFK)'), expr('In(C3, P1)'),  expr('In(C3, P2)'), expr('In(C3, P3)'),
            ]
    init = FluentState(pos, neg)
